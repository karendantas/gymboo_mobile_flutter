...
mixin _$Goal {
 ...
 int get id; int get weeklyWorkoutTarget;
...
@useResult
$Res call({
 int id, int weeklyWorkoutTarget
});
...
as int,weeklyWorkoutTarget: null == weeklyWorkoutTarget ? _self.weeklyWorkoutTarget : weeklyWorkoutTarget // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int weeklyWorkoutTarget)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Goal() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int weeklyWorkoutTarget)  $default,) {final _that = this;
switch (_that) {
case _Goal():
return $default(_that.id,_that.weeklyWorkoutTarget);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int weeklyWorkoutTarget)?  $default,) {final _that = this;
switch (_that) {
case _Goal() when $default != null:
return $default(_that.id,_that.weeklyWorkoutTarget);case _:
  return null;
